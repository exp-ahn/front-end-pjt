...
const Footer = () => {
    ...
    const privatePolicyBtnHandler = () => {
        Swal.fire({
            ...
            html: '<br>수집하는 개인정보의 항목 및 목적<br><br><br>1.1 회사는 다음과 같은 개인정보 항목을 수집할 수 있습니다: [성명, 연락처, 이메일 주소 등].1.2 수집한 개인정보는 다음과 같은 목적으로 이용될 수 있습니다: [서비스 제공, 문의 응답, 공지사항 전달 등].<br><br><br>개인정보 수집 방법<br>2.1 회사는 다음과 같은 방법으로 개인정보를 수집할 수 있습니다: [회원가입 시, 문의하기 양식 작성 시, 쿠키 및 로그 파일 등].<br><br><br>개인정보의 보유 및 이용 기간<br><br><br>3.1 회사는 이용자의 개인정보를 개인정보 보유 및 이용기간 동안 보관 및 이용합니다.<br><br>3.2 개인정보 보유 및 이용기간은 회사의 개인정보 보호 정책에 따라 운영됩니다.<br><br><br>개인정보의 제공 및 제3자와의 공유<br><br><br>4.1 회사는 이용자의 개인정보를 제3자에게 제공하지 않습니다, 제공할 경우에는 이용자의 동의를 받을 것입니다.<br><br>4.2 단, 법령에 의해 요구되는 경우 또는 이용자의 동의가 있는 경우에는 예외적으로 제3자와의 공유가 이루어질 수 있습니다.<br><br><br>개인정보의 보호 조치<br><br><br>5.1 회사는 이용자의 개인정보를 안전하게 보호하기 위해 보안 조치를 취하고 있습니다.<br><br>5.2 회사는 개인정보의 분실, 도난, 누출, 변조 등을 방지하기 위해 기술적, 관리적, 물리적 조치를 적용합니다.<br><br><br>개인정보 이용자의 권리<br><br><br>6.1 이용자는 언제든지 자신의 개인정보에 대한 접근, 수정, 삭제를 요청할 수 있습니다.<br><br>6.2 이용자는 개인정보 수집 및 이용에 대한 동의 철회를 요청할 수 있습니다.<br><br><br>개인정보 보호 정책의 변경<br><br><br>7.1 회사는 개인정보 보호 정책을 필요에 따라 수정할 수 있습니다.<br><br>7.2 변경된 개인정보 보호 정책은 회사의 웹사이트나 앱을 통해 공지됩니다.<br><br><br>개인정보 보호 관련 문의<br><br><br>8.1 이용자는 개인정보 보호에 관한 문의나 불만을 회사에 제출할 수 있습니다.<br><br>8.2 회사는 이용자의 문의에 신속하고 성실하게 답변할 것입니다.',
            confirmButtonColor: '#3085d6',
            customClass: 'swal-footer',
        });
    };
    const refundPolicyBtnHandler = () => {
        Swal.fire({
            ...
            html: '<br>취소 요청<br><br><br>1.1 광고주는 광고를 취소하고 환불을 요청할 수 있습니다.1.2 취소 요청은 서면, 전화 또는 이메일을 통해 회사에 통보해야 합니다.<br><br><br>환불 정책<br>2.1 환불 가능 기간: 광고가 시작되기 전까지 취소 요청 시에 한해 환불이 가능합니다.<br>2.2 환불 수수료: 환불 시 일정한 수수료가 적용될 수 있습니다. 수수료는 광고의 종류 및 규모 등에 따라 다를 수 있습니다.2.3 환불 방법: 환불은 원래 결제 방식을 통해 이루어집니다. 예를 들어, 신용카드 결제로 이루어진 경우에는 해당 신용카드로 환불될 수 있습니다.<br><br>2.4 부분 환불: 광고가 시작된 후에는 부분 환불이 불가능할 수 있으며, 환불 가능한 부분에 대해서만 환불이 이루어집니다.<br><br><br>예외 사항<br><br><br>3.1 광고주의 과실로 인한 문제 또는 규정 위반으로 인해 환불이 요구되는 경우, 회사는 해당 사유를 검토한 후 환불 여부를 결정합니다.<br><br>3.2 광고가 이미 시작된 후에는 환불이 어려울 수 있으며, 이 경우에는 다른 형태의 보상 또는 조정을 제공할 수 있습니다.<br><br><br>환불 처리 시간<br><br><br>4.1 환불 처리 시간은 일반적으로 요청을 받은 후 5-10 영업일 정도 소요될 수 있습니다.<br><br>4.2 처리 시간은 광고의 규모와 회사의 내부 절차에 따라 달라질 수 있습니다.<br><br><br>기타 조항<br><br><br>5.1 본 정책은 회사의 환불 정책에 대한 일부로서, 회사는 필요한 경우에는 본 정책을 수정할 수 있습니다.<br><br>5.2 본 정책에 명시되지 않은 사항은 관련 법령 및 회사의 정책에 따릅니다.<br><br>',
            confirmButtonColor: '#3085d6',
            customClass: 'swal-footer',
        });
    };
    const announcementBtnHandler = () => {
        Swal.fire({
            ...
            html: '<br>서비스 출시<br><br><br>일시: 2023-06-23<br><br>내용: ONETEAM-TOURGUIDEFORYOU 출시!<br><br>다양한 기능의 여행 정보 서비스를 경험해보세요!<br><br>서비스 업그레이드 안내<br><br><br>서비스 중단 예고<br><br><br>일시: 2023-06-23<br><br>내용: DB 서버 점검<br><br>잠시 중단: 서비스 업그레이드를 위해 일시적으로 서비스가 중단될 수 있습니다.<br><br><br>문의처<br><br><br>문의처: [센텀벤처타운 5층 광안대교 2실]<br><br>운영시간: [09:00~18:00]',
            confirmButtonColor: '#3085d6',
            customClass: 'swal-footer',
        });
    };
